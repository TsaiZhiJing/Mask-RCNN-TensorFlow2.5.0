...
# COCO_MODEL_PATH = os.path.join(ROOT_DIR, "resnet34_imagenet_1000.h5")  #34層
...
class DrugDataset(utils.Dataset):
    ...
    def load_mask(self, image_id):
        ...
        for i in range(len(labels)):
            ...
            elif labels[i].find("dent") != -1:
                # print "dent"
                labels_form.append("dent")
...
# 基础设置
# dataset_root_path = "datasets-test/test1/"
